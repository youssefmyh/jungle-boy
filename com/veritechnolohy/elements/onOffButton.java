...
/*    */ 
/*    */ public class onOffButton extends MainElement
...
/* 36 */     this.onButton = ImageLoader.loadImage("on");
/* 37 */     this.offButton = ImageLoader.loadImage("off");
/* 38 */     this.locationx = 285;
/* 39 */     this.locationy = 13;
/* 40 */     this.elemntWidth = this.onButton.getWidth();
/* 41 */     this.elementHeight = this.onButton.getHeight();
/*    */   }
/*    */ 
 ...
 * Qualified Name:     com.veritechnolohy.elements.onOffButton
